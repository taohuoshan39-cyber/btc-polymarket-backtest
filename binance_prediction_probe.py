...
def signed_get(path: str, **params: Any) -> Any:
...
def main() -> None:
    ...
    snapshot = {
        ...
        "raw_response": raw if not candidates else None,
    ...
    if not candidates:
        print("No BTC 15m candidate found; inspect raw_response before enabling trading.", file=sys.stderr)
        raise SystemExit(2)
